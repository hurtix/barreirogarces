...
<div class="w-full flex flex-col justify-between min-h-screen bg-dark max-w-full lg:max-w-[414px] mx-auto py-8">
  <div class="flex flex-col items-center justify-center">
    <img class="brightness-0 invert-100 w-[30vh]" src="https://barreirogarces.com/wp-content/uploads/2021/07/Barreiro-Garces-Letras.png" alt="">
  
  <ul class="list-none mt-8 flex justify-center gap-x-12 text-white  [&_li_svg]:fill-white [&_li_svg]:w-6 [&_li_svg]:h-6">
            <li>
