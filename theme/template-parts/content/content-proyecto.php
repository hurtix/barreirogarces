...
<div <?php post_class('bg-center bg-no-repeat bg-cover'); ?> id="post-<?php the_ID(); ?>" style="background-image: url(<?php echo $image[0]; ?>);">
    <div class="bg-black/40 flex flex-row lg:flex-col items-end pb-4 lg:pb-0 lg:items-center justify-center h-full gap-3 px-4 lg:px-0">
        ...
        <h1 class="text-white font-normal text-2xl leading-none lg:leading-normal"><?php the_title(); ?></h1>
